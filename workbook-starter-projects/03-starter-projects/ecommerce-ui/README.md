...
--name ecommerce-app scophee/ecommerce-app
```
...
3. Run the following command to build the image:
   ...
   ```bash
   docker build -t scophee/ecommerce-app .
   ```

   This command will build the Docker image using the provided Dockerfile and tag it as `scophee/ecommerce-app`.
